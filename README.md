# [Use Bootstrap-jekyll](https://primertest.github.io/base/)

[Use Bootstrap Jekyll](https://primertest.github.io/base/) is a one page theme for use with jekyll static site
...
**[View Live Preview](https://primertest.github.io/base/)**
...
* [Download the latest release on Start Bootstrap](https://github.com/primertest/base)
* Install via npm: `npm i startbootstrap-creative`
* Clone the repo: `git clone https://github.com/primertest/base`
* [Fork, Clone, or Download on GitHub](https://github.com/primertest/base)
...
Have a bug or an issue with this template? [Open a new issue](https://github.com/primertest/base/issues) here on GitHub or leave a comment on the [template overview page at Start Bootstrap](http://startbootstrap.com/template-overviews/creative/).
